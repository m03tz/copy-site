    ...
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0">
        ...
        <Command
          ...
          className="[&_[cmdk-group-heading]]:text-muted-foreground **:[cmdk-group-heading]:px-2 **:[cmdk-group-heading]:font-medium **:[cmdk-input-wrapper]_svg:h-5 **:[cmdk-input-wrapper]_svg:w-5 **:[cmdk-input]:h-12 **:[cmdk-item]:px-2 **:[cmdk-item]:py-3 **:[cmdk-item]_svg:h-5 **:[cmdk-item]_svg:w-5"
        >
          {children}
        </Command>
      </DialogContent>
